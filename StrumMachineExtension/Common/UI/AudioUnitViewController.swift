...
private let log = Logger(subsystem: "BeatMachine.StrumMachineExtension", category: "AudioUnitViewController")

public class AudioUnitViewController: AUViewController, AUAudioUnitFactory {
    var audioUnit: AUAudioUnit?
    
    var hostingController: HostingController<StrumMachineExtensionMainView>?
	...
	*/
    ...
    public func createAudioUnit(with componentDescription: AudioComponentDescription) throws -> AUAudioUnit {
        audioUnit = try StrumMachineExtensionAudioUnit(componentDescription: componentDescription, options: [])
        
        guard let audioUnit = self.audioUnit as? StrumMachineExtensionAudioUnit else {
            log.error("Unable to create StrumMachineExtensionAudioUnit")
            return audioUnit!
        }
        ...
        audioUnit.setupParameterTree(StrumMachineExtensionParameterSpecs.createAUParameterTree())
    ...
    private func configureSwiftUIView(audioUnit: AUAudioUnit) {
        ...
        let content = StrumMachineExtensionMainView(parameterTree: observableParameterTree)
